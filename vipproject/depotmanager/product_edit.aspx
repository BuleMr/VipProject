<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product_edit.aspx.cs" Inherits="depotmanager_product_edit" %>
        ...
        <div class="formbody">
            ...
            <div class="tab-content">
                <dl>
                    <dt>会员卡号</dt>
                    <dd>
                        <asp:TextBox ID="txtUserName" runat="server" MaxLength="200" CssClass="input normal" datatype="*" errormsg="" Width="300"></asp:TextBox>
                ...
                <dl>
                    <dt>消费次数</dt>
                    <dd>
                        <asp:TextBox ID="txtExp" runat="server" CssClass="input small" datatype="n" sucmsg=" " MaxLength="8"></asp:TextBox>
                        <span class="Validform_checktip">*</span></dd>
                </dl>
                <dl>
                    <dt>积分</dt>
                    <dd>
                        <asp:TextBox ID="txtPoint" runat="server" CssClass="input small" datatype="n" sucmsg=" " MaxLength="8"></asp:TextBox>
                        <span class="Validform_checktip">*</span></dd>
                </dl>
            </div>
            <!--/会员信息-->
