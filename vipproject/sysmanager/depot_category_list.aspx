<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="depot_category_list.aspx.cs" Inherits="sysmanager_depot_category_list" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="rightinfo">
            <div class="tools">
                <ul class="toolbar">
                    <a href="depot_category_edit.aspx?action=Add">
                        <li><span>
            ...
            <dl class="seachform">
                <dd>
                    <label>地区名称</label><span class="single-select"><asp:TextBox ID="txtKeywords" runat="server" CssClass="scinput"></asp:TextBox></span></dd>
                <dd class="cx">
