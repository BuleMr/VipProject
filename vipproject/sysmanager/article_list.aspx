<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_list.aspx.cs" Inherits="sysmanager_article_list" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="rightinfo">
            ...
            <div class="tools">
                ...
                <ul class="toolbar">
                    <a href="article_edit.aspx?action=Add">
                        <li><span>
            ...
            <dl class="seachform">
                <dd>
                    <label>公告标题</label><span class="single-select"><asp:TextBox ID="txtKeywords" runat="server" CssClass="scinput" Width="300"></asp:TextBox></span></dd>
                <dd class="cx">
